                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    @foreach($data as $value)
                                        <tr>
                                            ...
                                            <td>{!! $value->status?"confirmed":"pending" !!}</td>

                                            <td class="uk-text-center">

                                                <a href="{!! route('order_edit',$value->id) !!}" class="batch-edit"><i class=" material-icons">&#xE254;</i></a>
                                                <a onclick="deleterow(this);return false;" href="{{ route('order_destroy',$value->id) }}"><i data-uk-tooltip="{pos:'top'}" title="Delete" class="material-icons">&#xE872;</i></a>
