...
@section('content')
    ...
    <div class="uk-grid" >
        <div class="uk-width-large-10-10">
            ...
            @endif
            {!! Form::open(['url' => route("order_update",$data->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Order</span></h2>
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="title" name="name" value="{{ $data["name"] }}">
                                        @if($errors->has('name'))
                                            <br/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="title" value="{{ $data["email"] }}" name="email">
                                        @if($errors->has('email'))
                                            <br/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="title" value="{{ $data["phone"] }}" name="phone">
                                        @if($errors->has('phone'))
                                            <br/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <textarea type="text" name="address" id="summary" class="md-input" cols="4" rows="4"> {{ $data["address"] }}</textarea>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <textarea type="text" name="note" id="summary" class="md-input" cols="4" rows="4"> {{ $data["note"] }}</textarea>
                                        @if($errors->has('note'))
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select id="contact_category_id" name="status" data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" required>
                                            ...
                                            <option {{ $data->status==1?"selected":'' }} value="1">Confirmed</option>
