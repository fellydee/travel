...
@section('content')
    ...
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            @endif
            {!! Form::open(['url' => route("message_update",$data->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select id="contact_category_id" name="type" data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" required>
                                            <option value="">Select Type</option>
                                            <option {{ $data->type==1?"selected":'' }} value="1">active</option>
                                            <option  {{ $data->type==0?"selected":'' }} value="0">inactive</option>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label class="uk-vertical-align-middle" for="description">Details </label>
                                    </div>
                                    <div class="uk-width-medium-1-2">
                                        <label for="note">Details </label>
                                        <textarea class="ckeditor" type="text" name="details" id="details" class="md-input"> {!! $data["details"] !!}</textarea>
