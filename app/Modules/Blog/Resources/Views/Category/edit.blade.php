...
@section('content')
    ...
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            @endif
            {!! Form::open(['url' => route("blog_category_update",$cat->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Category</span></h2>
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="title" value="{{ $cat->title }}" name="title">
                                        @if($errors->has('title'))
                                            <br/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <textarea type="text"  name="summary" id="summary" class="md-input" cols="4" rows="4"> {{ $cat->summary }}</textarea>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <a href="{!! url($cat->thumbnail) !!}" download="{!! url($cat->thumbnail) !!}" class="batch-edit"><i class="material-icons">file_download</i></a>
