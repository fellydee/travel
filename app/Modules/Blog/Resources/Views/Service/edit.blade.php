...
@section('content')
    ...
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            @endif
            {!! Form::open(['url' => route("service_update",$service->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Edit Service</span></h2>
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="title" value="{{ $service->title }}" name="title">
                                        @if($errors->has('title'))
                                            <br/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <textarea type="text"  name="summary" id="summary" class="md-input" cols="4" rows="4"> {{ $service->summary }}</textarea>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <a href="{!! url($service->thumbnail) !!}" download="{!! url($service->thumbnail) !!}" class="batch-edit"><i class="material-icons">file_download</i></a>
...
@section('custom_footer_js')
    <script>
        $('#sidebar_service').addClass('current_section');
    </script>
