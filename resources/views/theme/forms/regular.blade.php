            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-2">
                    ...
                    <div class="uk-form-row">
                        ...
                        <textarea cols="30" rows="4" class="md-input">Tempore dicta maiores enim neque nesciunt eum ut provident quo cum molestias in modi odio necessitatibus nihil minima quis reiciendis quia ut omnis saepe libero eligendi.</textarea>
                    </div>
                </div>
                <div class="uk-width-medium-1-2">
                    ...
                    <div class="uk-form-row">
                        <label>Textarea</label>
                        <textarea cols="30" rows="4" class="md-input no_autosize">Nostrum magnam adipisci temporibus quas ab natus aut aperiam veritatis consequatur a rem et accusamus necessitatibus tempora aut est.</textarea>
                    </div>
                </div>
            </div>
        </div>
